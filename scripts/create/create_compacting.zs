...
// copy both lines below for renewable tuff
<recipetype:create:compacting>.addRecipe("gravel_tuff", <constant:create:heat_condition:none>, [<item:minecraft:tuff>], [<item:minecraft:gravel> * 9], [<fluid:minecraft:lava> * 250]);
<recipetype:create:compacting>.addRecipe("deepslate_tuff", <constant:create:heat_condition:none>, [<item:minecraft:tuff>], [<item:minecraft:deepslate> * 9], [<fluid:minecraft:lava> * 250]);
