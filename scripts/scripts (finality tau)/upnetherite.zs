...
recipes.removeByName("upgradednetherite_ultimate:ultimate_upgraded_netherite_ingot");
craftingTable.addShapeless("ultimate_netherite_ingot", <item:upgradednetherite_ultimate:ultimate_upgraded_netherite_ingot>, [
...
<recipetype:create:sequenced_assembly>.addRecipe(<recipetype:create:sequenced_assembly>.builder("seq_creativerite_ingot")
                                      ...
                                      .addOutput(<item:extendedcrafting:singularity>.withTag({Id: "extendedcrafting:netherite"}) * 1, 25) //.addOutput(<item:extendedcrafting:singularity>.withTag({Id: "extendedcrafting:blue_ice"}) * 1, 100)
