...
craftingTable.addShapeless("apprentice_spell_book", <item:ars_nouveau:apprentice_spell_book>, [<item:ars_nouveau:novice_spell_book>, <item:minecraft:crying_obsidian>, <item:create:rose_quartz>, <item:create:rose_quartz>, <item:create:rose_quartz>, <item:extendedcrafting:luminessence_block>, <item:extendedcrafting:luminessence_block>, <item:create:blaze_cake>, <item:create:blaze_cake>]);
// Ars T3 Book
recipes.removeByName("ars_nouveau:archmage_spell_book_upgrade");
craftingTable.addShapeless("archmage_spell_book_upgrade", <item:ars_nouveau:archmage_spell_book>, [<item:ars_nouveau:apprentice_spell_book>, <item:extendedcrafting:enhanced_ender_catalyst>, <item:ars_nouveau:wilden_tribute>, <item:projecte:dark_matter>, <item:projecte:dark_matter>, <item:projecte:dark_matter>, <item:projecte:dark_matter>, <item:projecte:dark_matter>, <item:minecraft:totem_of_undying>]);
